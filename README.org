...
#+BEGIN_SRC emacs-lisp
  ...
  (eddie/load-file "eddie-paths")
  (eddie/load-file "eddie-package")
  (eddie/load-file "eddie-theme")
  (eddie/load-file "eddie-appearance")
  (eddie/load-file "eddie-ido")
  (eddie/load-file "eddie-save")
  (eddie/load-file "eddie-java")
  (eddie/load-file "eddie-webkit")
  (eddie/load-file "eddie-adc3")
#+END_SRC
